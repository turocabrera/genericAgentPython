...
def consultar_agente(mensaje: str):
...
# La idea es que el chat por consola siga funcionando cuando ejecutamos ese archivo directamente, pero que no se arranque solo cuando FastAPI lo importe.
